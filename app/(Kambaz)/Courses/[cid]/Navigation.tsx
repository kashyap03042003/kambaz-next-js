...
export default function CourseNavigation() {
  ...
  const items = [
    ...
    { id: "wd-course-assignments-link",  label: "Assignments", href: `/Courses/${cid}/Assignments` }, // ✅ fixed id
    { id: "wd-course-quizzes-link",      label: "Quizzes",     href: `/Courses/${cid}/Quizzes` },     // ✅ fixed id
